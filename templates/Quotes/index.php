                            ...
                            <?php foreach ($quotes as $quote) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a class="btn btn-sm btn-action btn-icon btn-secondary shadow" href="<?= $this->Url->build(['action' => 'makeWord', $quote->id]) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="download">
