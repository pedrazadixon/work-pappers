                        ...
                        <tbody>
                            <?php foreach ($quotesStatuses as $quotesStatus) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a class="btn btn-sm btn-action btn-icon btn-2 btn-info" href="<?= $this->Url->build(['action' => 'view', $quotesStatus->id]) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="view">
                                            <span class="btn-inner--icon"><i class="material-icons">description</i></span>
                                        </a>
                                        <a class="btn btn-sm btn-action btn-icon btn-2 btn-warning" href="<?= $this->Url->build(['action' => 'edit', $quotesStatus->id]) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="edit">
