        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-secondary shadow-secondary border-radius-lg pt-4 pb-3">
                    <div class="row mx-3">
                        <div class="col-6">
                            <h6 class="text-white text-capitalize">Quotes Statuses</h6>
                        </div>
                        ...
                        <tbody>
                            <?php foreach ($quotesStatuses as $quotesStatus) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a class="btn btn-sm btn-action btn-icon btn-secondary shadow" href="<?= $this->Url->build(['action' => 'view', $quotesStatus->id]) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="view">
                                            <span class="btn-inner--icon"><i class="material-icons">description</i></span>
                                        </a>
                                        <a class="btn btn-sm btn-action btn-icon btn-secondary shadow" href="<?= $this->Url->build(['action' => 'edit', $quotesStatus->id]) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="edit">
                                        ...
                                        <?= $this->Form->postLink(
                                            ...
                                            [
                                                'confirm' => __('Are you sure you want to delete # {0}?', $quotesStatus->id),
                                                'escape' => false,
