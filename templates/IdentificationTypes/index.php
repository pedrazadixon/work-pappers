                        ...
                        <tbody>
                            <?php foreach ($identificationTypes as $identificationType) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a class="btn btn-sm btn-action btn-icon btn-secondary shadow" href="<?= $this->Url->build(['action' => 'view', $identificationType->id]) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="view">
                                            <span class="btn-inner--icon"><i class="material-icons">description</i></span>
                                        </a>
                                        <a class="btn btn-sm btn-action btn-icon btn-secondary shadow" href="<?= $this->Url->build(['action' => 'edit', $identificationType->id]) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="edit">
                                        ...
                                        <?= $this->Form->postLink(
                                            ...
                                            [
                                                'confirm' => __('Are you sure you want to delete # {0}?', $identificationType->id),
                                                'escape' => false,
