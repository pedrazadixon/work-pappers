        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-secondary shadow-secondary border-radius-lg pt-4 pb-3">
                    <div class="row mx-3">
                        <div class="col-12">
                            <h6 class="text-white text-capitalize">New Identification Type</h6>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body mt-0">
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        <?= $this->Form->postLink(
                            ...
                            ['confirm' => __('Are you sure you want to delete # {0}?', $identificationType->id), 'class' => 'btn btn-sm btn-outline-danger m-0']
                        ) ?>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="input-group input-group-static mb-4">
                            <label>acronym</label>
                            <?= $this->Form->control('acronym', ['class' => 'form-control', 'label' => false]); ?>
                        </div>
                    </div>
