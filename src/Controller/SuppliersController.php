...
class SuppliersController extends AppController
{
    ...
    public function view($id = null)
    {
        $supplier = $this->Suppliers->get($id, [
            'contain' => ['IdentificationTypes', 'Bills', 'Quotes'],
        ]);
    ...
    public function add()
    {
        ...
        $identificationTypes = $this->Suppliers->IdentificationTypes->find('list', ['limit' => 200])->all();
        $this->set(compact('supplier', 'identificationTypes'));
    }
